...
productsRouter.put("/:productId" , uploader.single("file") ,passport.authenticate("jwtAuth",{session:false}) ,isAuth, checkRole(["admin"]), ProductsController.PutProduct);

productsRouter.delete("/:productId",passport.authenticate("jwtAuth",{session:false}),isAuth, checkRole(["admin"]),ProductsController.DeleteProduct)
