...
export class CartManagerMongo{
    ...
    async updateCart(cartId,updateProperties){
        try {
            ...
            throw  new Error(`Could not  delete products from cart ${error.message}`);
    ...
    async daleteProductToCart(cartId,productId){
        try {
            ...
            if(product){
               ...
               cart.products= newProducts;
                ...
                throw  new Error(`Could not delete product to cart because it doesn't exist`);
            }
